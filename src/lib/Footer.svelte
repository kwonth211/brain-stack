...
<div
	class="max-w-4xl mx-auto w-full flex md:flex-row flex-col items-center md:justify-between py-8 mt-20 border-t border-cyan-800/20"
>
	<div class="text-cyan-800 flex items-center flex-none">
	...
	<div class="flex items-center mt-2 md:mt-0">
		<a class="group" aria-label="TaxPal on Twitter" href="https://twitter.com/steph_dietz_"
			><svg aria-hidden="true" class="mr-4 h-6 w-6 fill-cyan-800/50 group-hover:fill-white/70"
				><path
