...
>
	<button on:click class="flex items-center mb-4 md:mb-0 text-cyan-800">
		<TvIcon />
		<div class="text-2xl md:text-xl font-bold ml-2">brain-stack</div>
	</button>
	<a
		class="bg-white/20 hover:bg-white/50 shadow text-white hover:text-cyan-800 font-medium rounded p-2 text-sm flex items-center"
